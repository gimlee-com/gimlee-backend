...
By default, the MongoDB port (`27017`) is restricted. If you need to access the database from your local machine, you can pass your public IP to the `management_ips` variable.
