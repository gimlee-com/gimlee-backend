...
data class CreateUsersRequest(
    @Schema(description = "Optional PirateChain view key to register for the 'pirate_seller' user")
    val pirateViewKey: String? = null,
    @Schema(description = "Optional YCash view key to register for the 'ycash_seller' user")
