...
@Schema(description = "Full ticket detail with conversation")
data class TicketDetailDto(
    ...
    @Schema(description = "Conversation messages") val messages: List<TicketMessageDto>,
    @Schema(description = "Linked report IDs") val relatedReportIds: List<String>
)
