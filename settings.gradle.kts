...
include("gimlee-support")
include("gimlee-ratings")
include("gimlee-api")
...
project(":gimlee-support").projectDir = file("gimlee-support")
project(":gimlee-ratings").projectDir = file("gimlee-ratings")
